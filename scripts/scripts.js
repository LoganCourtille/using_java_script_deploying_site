...
let model_name = document.getElementById("model-text").innerHTML;
...
function recalculate(){
    ...
    if (model_name == "XYZ" || model_name == "Model XYZ" ){
        cost_label.innerHTML = duration * 100;
    } else if (model_name == "CPRG" || model_name == "Model CPRG"){
...
function change_duration(){
    ...
    console.log(duration_text.innerHTML);
